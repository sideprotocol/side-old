...
var (
	pattern_Query_EpochInfos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 3}, []string{"github.com", "sideprotocol", "sidechain", "epochs", "v1"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CurrentEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"github.com", "sideprotocol", "sidechain", "epochs", "v1", "current_epoch"}, "", runtime.AssumeColonVerbOpt(true)))
)
