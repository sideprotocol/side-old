...
// ChainIDPrefix defines the default chain ID prefix for Sidechain test chains
var ChainIDPrefix = "sidechain_7070-"
...
func NewTestChain(t *testing.T, coord *ibcgotesting.Coordinator, chainID string) *ibcgotesting.TestChain {
	...
	balance := banktypes.Balance{
		...
		Coins:   sdk.NewCoins(sdk.NewCoin(sidechain.BaseDenom, amount)),
	}
