...
var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = sidechainapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	// set bond demon to be aside
	stakingParams.BondDenom = sidechain.BaseDenom
	...
	for _, b := range balances {
		...
		totalSupply = totalSupply.Add(b.Coins.Add(sdk.NewCoin(sidechain.BaseDenom, bondAmt))...)
	}

	// add bonded amount to bonded pool module account
	balances = append(balances, banktypes.Balance{
		Address: authtypes.NewModuleAddress(stakingtypes.BondedPoolName).String(),
		Coins:   sdk.Coins{sdk.NewCoin(sidechain.BaseDenom, bondAmt)},
	})
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: sidechainapp.DefaultConsensusParams,
