...
// NewRootCmd creates a new root command for sidechaind. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(sidechainkr.Option()).
		WithViper(EnvPrefix).
...
func (a appCreator) appExport(
	...
	var sidechainApp *app.Sidechain
	...
	if height != -1 {
		sidechainApp = app.NewSidechain(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := sidechainApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		sidechainApp = app.NewSidechain(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return sidechainApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
